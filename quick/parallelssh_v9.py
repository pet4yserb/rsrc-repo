...
def main():     
    ...
    if answer1=='3':
        ...
        command_to_run ="nohup bash /tmp/"+script_to_copy+" &"
...
#pyinstaller --hidden-import ssh2.agent --hidden-import ssh2.pkey --hidden-import ssh2.channel --hidden-import ssh2.sftp_handle --hidden-import ssh2.listener --hidden-import ssh2.statinfo --hidden-import ssh2.knownhost --hidden-import ssh2.fileinfo --hidden-import ssh2.publickey --onefile parallelssh_v9.py
#then staticx to make it statically linked
#ssh.exceptions.SCPError: ('Error opening remote file %s for writing on host %s - %s', '/tmp/test.sh', '192.168.2.10', SCPProtocolError())